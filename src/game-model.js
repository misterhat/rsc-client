...
class GameModel {
    constructor(...args) {
        ...
        this.vertexViewX = [];
        this.vertexViewY = [];
        this.vertexIntensity = [];
        this.vertexAmbience = [];
        this.faceNumVertices = [];
        this.faceVertices = []; // keep this one an array of int32arrays
        this.faceFillFront = [];
        this.faceFillBack = [];
        ...
        this.vertexTransformedY = [];
        this.vertexTransformedZ = [];
        this.faceTransStateThing = [];
        this.faceBoundLeft = [];
        this.faceBoundRight = [];
        this.faceBoundBottom = [];
        this.faceBoundTop = [];
        this.faceBoundNear = [];
        this.faceBoundFar = [];
    ...
    _setLight_from4(ambience, diffuse, x, y, z) {
