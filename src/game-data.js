...
GameData.textureName = [];
GameData.textureSubtypeName = [];
GameData.objectModelIndex = [];
GameData.objectWidth = [];
GameData.objectHeight = [];
GameData.objectType = [];
GameData.objectElevation = [];
GameData.spellCount = 0;
GameData.npcWidth = [];
GameData.npcHeight = [];
GameData.npcSprite = [];
GameData.npcAttack = [];
GameData.npcStrength = [];
GameData.npcHits = [];
GameData.npcDefense = [];
GameData.npcAttackable = [];
GameData.spellLevel = [];
GameData.spellRunesRequired = [];
GameData.spellType = [];
GameData.spellRunesId = [];
GameData.spellRunesCount = [];
GameData.itemCount = 0;
GameData.itemSpriteCount = 0;
GameData.npcColourHair = [];
GameData.npcColourTop = [];
GameData.npcColorBottom = [];
GameData.npcColourSkin = [];
GameData.wallObjectHeight = [];
GameData.wallObjectTextureFront = [];
GameData.wallObjectTextureBack = [];
GameData.wallObjectAdjacent = [];
GameData.wallObjectInvisible = [];
GameData.tileCount = 0;
GameData.animationCharacterColour = [];
GameData.animationSomething = [];
GameData.animationHasA = [];
GameData.animationHasF = [];
GameData.animationNumber = [];
GameData.wallObjectCount = 0;
GameData.prayerLevel = [];
GameData.prayerDrain = [];
GameData.tileDecoration = [];
GameData.tileType = [];
GameData.tileAdjacent = [];
GameData.modelCount = 0;
GameData.roofHeight = [];
GameData.roofNumVertices = [];
...
GameData.npcCommand = [];
GameData.animationName = [];
GameData.itemPicture = [];
GameData.itemBasePrice = [];
GameData.itemStackable = [];
GameData.itemUnused = [];
GameData.itemWearable = [];
GameData.itemMask = [];
GameData.itemSpecial = [];
GameData.itemMembers = [];
...
GameData.objectCommand1 = [];
GameData.objectCommand2 = [];
GameData.npcWalkModel = [];
GameData.npcCombatModel = [];
GameData.npcCombatAnimation = [];
GameData.dataString = [];
GameData.dataInteger = [];
GameData.stringOffset = 0;
GameData.offset = 0;
